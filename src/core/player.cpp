   ...
   , m_backglassOutput("Visual Pinball - Backglass", live_table->m_settings, Settings::Backglass, "Backglass")
{
 ...
 #pragma message ( "Warning: No CPU float ignore denorm implemented" )
   ...
   VPinballLib::WindowCreatedData windowCreatedData = { 
      (void*)SDL_GetPointerProperty(props, SDL_PROP_WINDOW_UIKIT_WINDOW_POINTER, NULL),
      (void*)SDL_GetRenderMetalLayer(SDL_GetRenderer(m_playfieldWnd->GetCore())),
      SDL_GetWindowTitle(m_playfieldWnd->GetCore())
   };
