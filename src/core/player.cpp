...
#ifdef __LIBVPINBALL__
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_CREATING_PLAYER, nullptr);
#endif
...
#ifdef __LIBVPINBALL__
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_PLAYER_STARTED, nullptr);
#endif
...
#ifdef __LIBVPINBALL__
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_PLAYER_CLOSING, nullptr);
#endif
...
#ifdef __LIBVPINBALL__
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_PLAYER_CLOSED, nullptr);
#endif
}
...
#else
   while (VPinballLib::VPinballLib::Instance().PollEvent(e))
#endif
   {
      switch (e.type)
      {
