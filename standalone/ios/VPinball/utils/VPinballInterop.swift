...
@_silgen_name("VPinballSetEventCallback")
func VPinballSetEventCallback(_ callback: VPinballEventCallback)
...
func VPinballExtractScript() -> CInt
...
func VPinballImportTable(_ sourceFile: UnsafePointer<CChar>) -> CInt
