...
static void (*g_swift_callback)(void*) = nullptr;

extern "C" void VPinball_SetSwiftCallback(void (*callback)(void*)) 
{
...
SDL_AppResult SDL_AppInit(void **appstate, int argc, char **argv) 
{
   ...
   SDL_Window* window =  SDL_CreateWindow("VPX", 0, 0, SDL_WINDOW_FULLSCREEN);

   if (g_swift_callback)
      g_swift_callback(window);
   else {
      SDL_Log("No callback registered");
   }
