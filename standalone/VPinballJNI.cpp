...
void* NativeCallbackHandler(VPINBALL_EVENT event, void* data)
{
   ...
   jmethodID onEventMethod = env->GetMethodID(callbackClass, "onEvent", "(ILjava/lang/Object;)Ljava/lang/Object;");

   if (!onEventMethod)
      return nullptr;

   jobject result = env->CallObjectMethod(globalCallbackRef, onEventMethod, (jint)event, nullptr);
...
JNIEXPORT void JNICALL Java_VPinballJNI_VPinballInit(JNIEnv* env, jobject obj, jobject callback)
{
   ...
   VPinballInit(NativeCallbackHandler);
}
