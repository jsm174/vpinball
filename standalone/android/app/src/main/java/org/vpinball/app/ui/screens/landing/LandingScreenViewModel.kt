        ...
        tableJob =
            viewModelScope.launch(Dispatchers.IO) {
                try {
                    ...
                    val jsonString = vpinballJNI.VPinballGetTables()
                    VPinballManager.log(org.vpinball.app.jni.VPinballLogLevel.DEBUG, "fetchTables: Received JSON (length=${jsonString.length})")
                    ...
                    VPinballManager.log(
                        ...
                        "fetchTables: Parsed ${tablesResponse.tableCount} tables, success=${tablesResponse.success}",
                    )
