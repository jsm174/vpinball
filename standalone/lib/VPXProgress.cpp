...
void VPXProgress::ItemHasBeenProcessed(int itemsCount, int totalItems)
{
   ...
   VPinballLib::VPinball::GetInstance().SendEvent(VPinballLib::Event::LoadingItems, &progressData);
}
...
void VPXProgress::SoundHasBeenProcessed(int soundCount, int totalSounds) 
{
   ...
   VPinballLib::VPinball::GetInstance().SendEvent(VPinballLib::Event::LoadingSounds, &progressData);
}
...
void VPXProgress::ImageHasBeenProcessed(int imageCount, int totalImages)
{
   ...
   VPinballLib::VPinball::GetInstance().SendEvent(VPinballLib::Event::LoadingImages, &progressData);
}
...
void VPXProgress::FontHasBeenProcessed(int fontCount, int totalFonts)
{
   ...
   VPinballLib::VPinball::GetInstance().SendEvent(VPinballLib::Event::LoadingFonts, &progressData);
}
...
void VPXProgress::CollectionHasBeenProcessed(int collectionCount, int totalCollections)
{
   ...
   VPinballLib::VPinball::GetInstance().SendEvent(VPinballLib::Event::LoadingCollections, &progressData);
}
