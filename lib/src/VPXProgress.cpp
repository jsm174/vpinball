...
void VPXProgress::ItemHasBeenProcessed(int itemsCount, int totalItems)
{
   ...
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_LOADING_ITEMS, &progressData);
}
...
void VPXProgress::SoundHasBeenProcessed(int soundCount, int totalSounds)
{
   ...
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_LOADING_SOUNDS, &progressData);
}
...
void VPXProgress::ImageHasBeenProcessed(int imageCount, int totalImages)
{
   ...
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_LOADING_IMAGES, &progressData);
}
...
void VPXProgress::FontHasBeenProcessed(int fontCount, int totalFonts)
{
   ...
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_LOADING_FONTS, &progressData);
}
...
void VPXProgress::CollectionHasBeenProcessed(int collectionCount, int totalCollections)
{
   ...
   VPinballLib::VPinballLib::Instance().SendEvent(VPINBALL_EVENT_LOADING_COLLECTIONS, &progressData);
}
