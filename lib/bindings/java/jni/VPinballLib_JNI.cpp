...
JNIEXPORT void JNICALL Java_org_vpinball_app_jni_VPinballJNI_VPinballStartup(JNIEnv* env, jobject obj, jobject callback)
{
   if (!callback)
      return;
   ...
   VPinballStartup(VPinballJNI_OnEventCallback);
}
