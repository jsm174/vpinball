...
// B2SSettingsCheckedState enum is defined in common.h
...
public:
   ...
   void* GetPluginHost() const { return m_pPluginHost; } // TODO: Remove PluginHost dependency
...
private:
   ...
   bool m_pluginsOn;
   void* m_pPluginHost; // TODO: Remove PluginHost dependency
   eDMDTypes m_dmdType;
   bool m_allOut;
   bool m_allOff;
   bool m_lampsOff;
