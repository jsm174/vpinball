...
public:
   ...
   void AssignStyle();
   void Draw(RendererGraphics* pGraphics);
   void DrawLight(RendererGraphics* pGraphics);
...
private:
   ...
   void PaintSegment(RendererGraphics* pGraphics, GraphicsPath* pPath);
   void GetGlassData();
   void GetLightData();
   void ResetCacheData();
   void SetTransform(RendererGraphics* pGraphics);
