...
void Segment::Draw(RendererGraphics* pGraphics)
{
...
void Segment::DrawLight(RendererGraphics* pGraphics)
{
   if (!m_on)
      return;
...
void Segment::PaintSegment(RendererGraphics* pGraphics, GraphicsPath* pPath)
{
...
void Segment::SetTransform(RendererGraphics* pGraphics)
{
   Matrix* pMatrix;
   if (!m_pExternMatrix)
      pMatrix = new Matrix();
